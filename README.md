...
| **Photo Blur & Privacy Redactor** | [`/tools/blur-image`](https://tools.rokyuddin.com/tools/blur-image) | Censor sensitive information in screenshots and photos with mosaic pixelation, Gaussian blur, blackout bars, and whiteout boxes. |
